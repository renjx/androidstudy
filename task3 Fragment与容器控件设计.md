...
public class PrefConstants {
    ...
    public static final String LICENCE_TERMS = "<html><body><h3>版权所有，违者不究</h3></body></html>";
...
有个同学出现了个很有意思的错误，就是下面的四个点不见了，所有的代码和样式都是一样，还是看不到，后来光标放到R.mipmap.ic_swipe_indicator_white_18dp上发现，系统下多个目录下有个这个文件，系统把该图标认成了36×36 px (0×0 dp @ anydpi)，所以看不到这几个点，删掉anydpi目录下的该文件，保留hdpi中的ic_swipe_indicator_white_18dp，错误解决。
